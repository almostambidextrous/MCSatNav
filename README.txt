...
- v2.1.0 requires you click on a banner to set the target location there
(similar to creating Map Markers). Also contains a custom recipe [4 iron + 1 quartz].

- v1.1.0 doesn't fuss with banners, but still contains the recipe.

- v0.5.1 is stripped down to just the basics. To get the satnav you'll have to
